...
if __name__ == '__main__':
	...
	l1 = AddNoiseToInput()
        ...
        l3 = FCLayer(activation_str='rectify', size=500)
        ...
        l5 = LSTM(truncate_gradient=100,size=1024,weights=None,seq_output=True,rng=None,
                skip_input=False,jump_up=False,grad_clip=True,g_low=-5.0,g_high=5.0)
        l6 = FCLayer(activation_str='rectify', size=500)
        l7 = FCLayer(activation_str='rectify', size=100)
        l8 = FCLayer(activation_str='identity', size=42)
	...
	net_struct = 'Noise-FC500-ReLU-FC500-ReLU-LSTM1024-LSTM1024-FC500-ReLU-FC100-ReLU-FC42'
