...
if __name__ == '__main__':
	...
	l1 = LSTM(truncate_gradient=50,size=128,weights=None,seq_output=True,rng=None,
                skip_input=False,jump_up=False,grad_clip=True,g_low=-10.0,g_high=10.0)
	l2 = LSTM(truncate_gradient=50,size=128,weights=None,seq_output=True,rng=None,
                skip_input=False,jump_up=False,grad_clip=True,g_low=-10.0,g_high=10.0)
	l3 = LSTM(truncate_gradient=50,size=42,weights=None,seq_output=True,rng=None,
                skip_input=False,jump_up=False,grad_clip=True,g_low=-10.0,g_high=10.0)
	layers = [l0, l1, l2, l3]
	#layers = [l0,l1, l3]
	#trY = T.dmatrix()
	...
	checkpointDir = '/home/luna/ssp/srnn/dome/simpleRNN/checkpoints/' + str(num_samples) + '_layer' + str(len(layers)-1) + '_epoch' + str(epochs) + '/'
