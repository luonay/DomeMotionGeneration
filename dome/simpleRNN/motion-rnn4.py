...
if __name__ == '__main__':
	...
	l1 = LSTM(truncate_gradient=100,size=1024,weights=None,seq_output=True,rng=None,
	...
	checkpointDir = '/home/luna/ssp/srnn/dome/simpleRNN/checkpoints/' + str(num_samples) + '_layer' + str(len(layers)-1) + '_epoch' + str(epochs) + '_size1024/'
