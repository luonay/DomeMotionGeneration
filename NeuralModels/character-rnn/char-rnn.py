...
if __name__ == '__main__':
	...
	if not os.path.exists('/home/luna/ssp/srnn/NeuralModels/character-rnn/checkpoints/'):
		os.mkdir('/home/luna/ssp/srnn/NeuralModels/character-rnn/checkpoints/')

	# Initializing network
	rnn = RNN(layers,softmax_loss,trY,1e-3)

	# Fitting model
	rnn.fitModel(X_tr,Y_tr,1,'/home/luna/ssp/srnn/NeuralModels/character-rnn/checkpoints/',epochs,batch_size,learning_rate_decay,decay_after)
